...
def extract_coin_data(message):
    return {
        ...
        "volume_sek": message["volumes"]["SEK"],
...
def create_postgres_sink():
    sink = PostgreSQLSink(
        ...
        table_name="sonic",  # New table for Sonic data
...
def main():
    app = Application(
        ...
        consumer_group="sonic_group",
        auto_offset_reset="earliest",
    )

    messages_topic = app.topic(name="sonic_messages", value_deserializer="json")
